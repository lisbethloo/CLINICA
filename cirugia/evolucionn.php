			...
			<div class="wrapper">
				...
				<nav>
					<ul id="menu">
						...
						<li  class="bg_none"><a onClick="return confirm('Esta seguro que desea ingresar a la lista de  pediatria? perderas los registros que no se hayan guardado');" href="pacienteslista.php">Ficha de paciente</a></li>
						<li id="menu_active"><a onClick="return confirm('Esta seguro que desea ingresar al menu pabellon? perderas los registros que no se hayan guardado');" href="../cirugia/pabellonmenu.php"></a>Calendario</li>
...
<table style="border:1px  #666666; color:# 666666 ; width:100%;  ">
   ...
   <table>
     <TR> 
		 ...
		 <tr> 
		  <td> <?php echo '<td><input value=" '.$fecha.' " name="fecha" type="hidden" /></label></td>';
		 ?> 
